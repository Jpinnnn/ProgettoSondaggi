...
const APIgetS = require('./APIs/APIsond/APIget');
const APIpostS = require('./APIs/APIsond/APIpost');
const APIpatchS = require('./APIs/APIsond/APIpatch');
const APIdeleteS = require('./APIs/APIsond/APIdelete');
